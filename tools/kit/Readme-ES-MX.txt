...
6) Ahora recuperaremos los archivos que generamos con el programa HWGSIPartition,  y veremos que tienes en el directorio HW  now deberia tener 7 archivos. Ejecutaremos el:
	3-GetIMG.cmd
